...
!----------------------------------------------
  subroutine para_bcastd(buff,num,irank,comm)
!----------------------------------------------
#ifdef MPI
      use modparallel
      implicit none
...
!---------------------------------------------------
  subroutine para_allreduced(sbuff,rbuff,num,comm)
!---------------------------------------------------
      use modparallel
      implicit none
...
!--------------------------------------------------------------------------------
  subroutine para_sendrecvd(sbuff,nums,dest,ntags,rbuff,numr,source,ntagr,comm)
!--------------------------------------------------------------------------------
      use modparallel
      implicit none
