...
!
!------------------------------------------------------------------------
  subroutine guessmo(cmoa,cmob,overinv,h1mtrx,ortho,databasis,datacomp)
!------------------------------------------------------------------------
!
...
&         write(*,'("   Guess MOs are generated using extended Huckel orbitals.")')
        ...
        if(scftype == 'UHF') call dcopy(databasis%nao**2,cmoa,1,cmob,1)
!
...
&         write(*,'("   Guess MOs are generated by diagonalizing core Hamiltonian matrix.",/)')
        call hcoreguess(cmoa,h1mtrx,ortho,overinv,databasis%nao,datacomp)
        if(scftype == 'UHF') call dcopy(databasis%nao**2,cmoa,1,cmob,1)
      else
        if(datacomp%master) &
...
!---------------------------------------------------------------------
  subroutine hcoreguess(cmo,h1mtrx,ortho,work,nao,datacomp)
!---------------------------------------------------------------------
!
