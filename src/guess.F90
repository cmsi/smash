...
&         write(*,'("   Guess MOs are read from checkpoint file and projected.",/)')
        call checkguess(cmoa,cmob,overinv,datacomp%nproc2,datacomp%myrank2,datacomp%mpi_comm1,datacomp%mpi_comm2,datacomp)
...
!------------------------------------------------------------------------------
  subroutine checkguess(cmoa,cmob,overinv,nproc2,myrank2,mpi_comm1,mpi_comm2,datacomp)
!------------------------------------------------------------------------------
!
! Read and project MOs
!
