...
!---------------------------------------------------------
  subroutine updatemo(cmo,overinv,datacomp)
!---------------------------------------------------------
!
...
!------------------------------------------------------------------------------
  subroutine checkguess(cmoa,cmob,overinv,datacomp)
!------------------------------------------------------------------------------
!
! Read and project MOs
!
...
!---------------------------------------------------------------------
  subroutine hcoreguess(cmo,h1mtrx,ortho,work,datacomp)
!---------------------------------------------------------------------
!
