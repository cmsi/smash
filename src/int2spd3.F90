...
&                     -r1(1,23)*three
              ...
              rrr(13)=-r7(13)-r5(13,3)*three-r5(4,8)-r5(6,8)-r3(4,15)*three-r3(6,15)*three &
&                     -r3(1,27)-r1(1,23)*three
...
&                     -r3(1,15)*six-r3(6,27)*three+r2(5,25)*six-r1(1,13)*three-r1(1,23)*three
              rrr( 2)=-r7(9)+r6(5,1)*two-r5(2,1)-r5(2,3)-r5(9,8)*three+r4(5,10)*six &
&                     -r3(2,7)*three-r3(2,15)*three
              rrr( 3)=-r7(10)+r6(6,1)*two-r5(3,1)-r5(3,3)-r5(10,8)*three+r4(6,10)*six &
&                     -r3(3,7)*three-r3(3,15)*three
              rrr( 4)=-r7(13)+r6(8,1)*two-r5(4,1)-r5(4,3)-r5(6,8)-r5(13,8)+r4(3,10)*two &
&                     +r4(8,10)*two-r3(1,7)-r3(4,7)-r3(1,15)-r3(4,15)-r3(6,27)+r2(5,25)*two &
&                     -r1(1,13)-r1(1,23)
...
&                     +r4(10,10)*two-r3(1,7)-r3(6,7)-r3(1,15)-r3(6,15)-r3(6,27)+r2(5,25)*two &
&                     -r1(1,13)-r1(1,23)
              rrr( 7)=-r7(18)+r6(12,1)*two-r5(7,1)-r5(7,3)-r5(9,8)*three+r4(5,10)*six &
&                     -r3(2,7)*three-r3(2,15)*three
...
&                     -r3(3,7)*three-r3(3,15)*three
              rrr(11)=-r7(24)+r6(17,1)*two-r5(11,1)-r5(11,3)-r5(13,8)*six+r4(8,10)*p12 &
&                     -r3(4,7)*six-r3(4,15)*six-r3(6,27)*three+r2(5,25)*six-r1(1,13)*three &
&                     -r1(1,23)*three
...
&                     +r4(10,10)*two-r3(4,7)-r3(6,7)-r3(4,15)-r3(6,15)-r3(6,27)+r2(5,25)*two &
&                     -r1(1,13)-r1(1,23)
              rrr(14)=-r7(27)+r6(20,1)*two-r5(14,1)-r5(14,3)-r5(14,8)*three+r4(9,10)*six &
&                     -r3(5,7)*three-r3(5,15)*three
              rrr(15)=-r7(28)+r6(21,1)*two-r5(15,1)-r5(15,3)-r5(15,8)*six+r4(10,10)*p12 &
&                     -r3(6,7)*six-r3(6,15)*six-r3(6,27)*three+r2(5,25)*six-r1(1,13)*three &
&                     -r1(1,23)*three
...
&                     -r2(4,22)
              ...
              rxyz(23)=-r5(6,9)+r4(3,11)*two-r3(1,8)-r3(1,16)-r3(6,28)+r2(5,26)*two-r1(1,14) &
&                      -r1(1,24)
              rxyz(24)=-r5(6,10)+r4(3,12)*two-r3(1,9)-r3(1,17)-r3(6,29)+r2(5,27)*two-r1(1,15) &
&                      -r1(1,25)
              rxyz(25)=-r5(6,11)+r4(3,13)*two-r3(1,10)-r3(1,18)-r3(6,30)+r2(5,28)*two-r1(1,16) &
&                      -r1(1,26)
              rxyz(26)=-r4(6,20)+r3(3,21)*two-r2(1,15)-r2(1,23)
              rxyz(27)=-r4(6,21)+r3(3,22)*two-r2(1,16)-r2(1,24)
              rxyz(28)=-r6(15,3)+r5(10,4)*two-r4(6,4)-r4(6,8)-r4(6,18)+r3(3,19)*two-r2(1,13) &
&                      -r2(1,21)
              rxyz(29)=-r6(15,4)+r5(10,5)*two-r4(6,5)-r4(6,9)-r4(6,19)+r3(3,20)*two-r2(1,14) &
&                      -r2(1,22)
              rxyz(30)=-r6(10,3)+r5(6,4)*two-r4(3,4)-r4(3,8)-r4(10,18)+r3(6,19)*two-r2(5,13) &
&                      -r2(5,21)
              rxyz(31)=-r6(10,4)+r5(6,5)*two-r4(3,5)-r4(3,9)-r4(10,19)+r3(6,20)*two-r2(5,14) &
&                      -r2(5,22)
              rxyz(32)=-r5(15,9)+r4(10,11)*two-r3(6,8)-r3(6,16)-r3(6,28)+r2(5,26)*two-r1(1,14) &
&                      -r1(1,24)
              rxyz(33)=-r5(15,10)+r4(10,12)*two-r3(6,9)-r3(6,17)-r3(6,29)+r2(5,27)*two-r1(1,15) &
&                      -r1(1,25)
              rxyz(34)=-r5(15,11)+r4(10,13)*two-r3(6,10)-r3(6,18)-r3(6,30)+r2(5,28)*two-r1(1,16) &
&                      -r1(1,26)
              rxyz(35)=-r4(10,20)+r3(6,21)*two-r2(5,15)-r2(5,23)
              rxyz(36)=-r4(10,21)+r3(6,22)*two-r2(5,16)-r2(5,24)
              rxyz(37)=-r6(6,3)+r5(3,4)*two-r4(1,4)-r4(1,8)-r4(6,18)*three+r3(3,19)*six &
&                      -r2(1,13)*three-r2(1,21)*three
              rxyz(38)=-r6(6,4)+r5(3,5)*two-r4(1,5)-r4(1,9)-r4(6,19)*three+r3(3,20)*six &
&                      -r2(1,14)*three-r2(1,22)*three
...
&                     -r3(8,15)-r3(3,27)+r2(1,5)+r2(2,5)+r2(1,25)-r1(3,23)+r0(6)
              ...
              rrr( 6)=-r7(10)+r6(6,1)-r5(10,3)-r5(3,8)-r5(10,8)+r4(6,2)+r4(1,10)+r4(6,10) &
&                     -r3(3,15)-r3(10,15)-r3(3,27)+r2(1,5)+r2(3,5)+r2(1,25)-r1(3,23)+r0(6)
              rrr( 7)=-r7(12)+r6(7,1)-r5(12,3)-r5(5,8)*three+r4(7,2)+r4(2,10)*three &
&                     -r3(5,15)*three+r2(4,5)*three
              ...
              rrr(10)=-r7(15)+r6(10,1)-r5(15,3)-r5(6,8)*three+r4(10,2)+r4(3,10)*three &
&                     -r3(6,15)*three+r2(5,5)*three
...
&                     -r3(3,27)*three+r2(2,5)*six+r2(1,25)*three-r1(3,23)*three+r0(6)*three
              rrr(12)=-r7(18)+r6(12,1)-r5(18,3)-r5(9,8)*three+r4(12,2)+r4(5,10)*three &
&                     -r3(9,15)*three+r2(6,5)*three
              rrr(13)=-r7(19)+r6(13,1)-r5(19,3)-r5(8,8)-r5(10,8)+r4(13,2)+r4(4,10)+r4(6,10) &
&                     -r3(8,15)-r3(10,15)-r3(3,27)+r2(2,5)+r2(3,5)+r2(1,25)-r1(3,23)+r0(6)
              rrr(14)=-r7(20)+r6(14,1)-r5(20,3)-r5(9,8)*three+r4(14,2)+r4(5,10)*three &
&                     -r3(9,15)*three+r2(6,5)*three
...
&                     -r2(6,22)*three+r1(2,6)*three
              ...
              rxyz(37)=-r6(3,3)+r5(1,4)-r4(3,8)-r4(3,18)*three+r3(1,3)+r3(1,19)*three &
&                      -r2(5,21)*three+r1(1,5)*three
              rxyz(38)=-r6(3,4)+r5(1,5)-r4(3,9)-r4(3,19)*three+r3(1,4)+r3(1,20)*three &
&                      -r2(5,22)*three+r1(1,6)*three
              ...
              rxyz(44)=-r6(15,3)+r5(10,4)-r4(15,8)-r4(6,18)*three+r3(10,3)+r3(3,19)*three &
&                      -r2(3,21)*three+r1(3,5)*three
              rxyz(45)=-r6(15,4)+r5(10,5)-r4(15,9)-r4(6,19)*three+r3(10,4)+r3(3,20)*three &
&                      -r2(3,22)*three+r1(3,6)*three
            ...
            case(8)
              ...
              rrr( 4)=-r7(16)-r5(7,3)*three-r5(7,8)-r5(16,8)-r3(2,15)*three-r3(7,15)*three &
&                     -r3(7,27)-r1(2,23)*three
              rrr( 5)=-r7(17)-r5(8,3)*three-r5(17,8)-r3(8,15)*three
              rrr( 6)=-r7(18)-r5(9,3)*three-r5(7,8)-r5(18,8)-r3(2,15)*three-r3(9,15)*three &
&                     -r3(7,27)-r1(2,23)*three
              ...
              rrr(13)=-r7(31)-r5(18,3)*three-r5(16,8)-r5(18,8)-r3(7,15)*three-r3(9,15)*three &
&                     -r3(7,27)-r1(2,23)*three
...
&                     -r3(2,15)*six-r3(9,27)*three+r2(6,25)*six-r1(2,13)*three-r1(2,23)*three
              rrr( 2)=-r7(13)+r6(8,1)*two-r5(4,1)-r5(4,3)-r5(13,8)*three+r4(8,10)*six &
&                     -r3(4,7)*three-r3(4,15)*three
              rrr( 3)=-r7(14)+r6(9,1)*two-r5(5,1)-r5(5,3)-r5(14,8)*three+r4(9,10)*six &
&                     -r3(5,7)*three-r3(5,15)*three
              rrr( 4)=-r7(18)+r6(12,1)*two-r5(7,1)-r5(7,3)-r5(9,8)-r5(18,8)+r4(5,10)*two &
&                     +r4(12,10)*two-r3(2,7)-r3(7,7)-r3(2,15)-r3(7,15)-r3(9,27)+r2(6,25)*two &
&                     -r1(2,13)-r1(2,23)
...
&                     +r4(14,10)*two-r3(2,7)-r3(9,7)-r3(2,15)-r3(9,15)-r3(9,27)+r2(6,25)*two &
&                     -r1(2,13)-r1(2,23)
...
&                     -r3(5,7)*three-r3(5,15)*three
              rrr(11)=-r7(31)+r6(23,1)*two-r5(16,1)-r5(16,3)-r5(18,8)*six+r4(12,10)*p12 &
&                     -r3(7,7)*six-r3(7,15)*six-r3(9,27)*three+r2(6,25)*six-r1(2,13)*three &
&                     -r1(2,23)*three
...
&                     +r4(14,10)*two-r3(7,7)-r3(9,7)-r3(7,15)-r3(9,15)-r3(9,27)+r2(6,25)*two &
&                     -r1(2,13)-r1(2,23)
              rrr(14)=-r7(34)+r6(26,1)*two-r5(19,1)-r5(19,3)-r5(19,8)*three+r4(13,10)*six &
&                     -r3(8,7)*three-r3(8,15)*three
              rrr(15)=-r7(35)+r6(27,1)*two-r5(20,1)-r5(20,3)-r5(20,8)*six+r4(14,10)*p12 &
&                     -r3(9,7)*six-r3(9,15)*six-r3(9,27)*three+r2(6,25)*six-r1(2,13)*three &
&                     -r1(2,23)*three
...
&                      -r2(2,22)
              ...
              rxyz(23)=-r5(9,9)+r4(5,11)*two-r3(2,8)-r3(2,16)-r3(9,28)+r2(6,26)*two-r1(2,14) &
&                      -r1(2,24)
              rxyz(24)=-r5(9,10)+r4(5,12)*two-r3(2,9)-r3(2,17)-r3(9,29)+r2(6,27)*two-r1(2,15) &
&                      -r1(2,25)
              rxyz(25)=-r5(9,11)+r4(5,13)*two-r3(2,10)-r3(2,18)-r3(9,30)+r2(6,28)*two-r1(2,16) &
&                      -r1(2,26)
              rxyz(26)=-r4(9,20)+r3(5,21)*two-r2(4,15)-r2(4,23)
              rxyz(27)=-r4(9,21)+r3(5,22)*two-r2(4,16)-r2(4,24)
              rxyz(28)=-r6(20,3)+r5(14,4)*two-r4(9,4)-r4(9,8)-r4(9,18)+r3(5,19)*two-r2(4,13) &
&                      -r2(4,21)
              rxyz(29)=-r6(20,4)+r5(14,5)*two-r4(9,5)-r4(9,9)-r4(9,19)+r3(5,20)*two-r2(4,14) &
&                      -r2(4,22)
              rxyz(30)=-r6(14,3)+r5(9,4)*two-r4(5,4)-r4(5,8)-r4(14,18)+r3(9,19)*two-r2(6,13) &
&                      -r2(6,21)
              rxyz(31)=-r6(14,4)+r5(9,5)*two-r4(5,5)-r4(5,9)-r4(14,19)+r3(9,20)*two-r2(6,14) &
&                      -r2(6,22)
              rxyz(32)=-r5(20,9)+r4(14,11)*two-r3(9,8)-r3(9,16)-r3(9,28)+r2(6,26)*two-r1(2,14) &
&                      -r1(2,24)
              rxyz(33)=-r5(20,10)+r4(14,12)*two-r3(9,9)-r3(9,17)-r3(9,29)+r2(6,27)*two-r1(2,15) &
&                      -r1(2,25)
              rxyz(34)=-r5(20,11)+r4(14,13)*two-r3(9,10)-r3(9,18)-r3(9,30)+r2(6,28)*two-r1(2,16) &
&                      -r1(2,26)
              rxyz(35)=-r4(14,20)+r3(9,21)*two-r2(6,15)-r2(6,23)
              rxyz(36)=-r4(14,21)+r3(9,22)*two-r2(6,16)-r2(6,24)
              rxyz(37)=-r6(9,3)+r5(5,4)*two-r4(2,4)-r4(2,8)-r4(9,18)*three+r3(5,19)*six &
&                      -r2(4,13)*three-r2(4,21)*three
              rxyz(38)=-r6(9,4)+r5(5,5)*two-r4(2,5)-r4(2,9)-r4(9,19)*three+r3(5,20)*six &
&                      -r2(4,14)*three-r2(4,22)*three
...
&                  -r3(8,27)*three+r2(1,5)*six+r2(2,25)*three-r1(3,23)*three+r0(6)*three
              rrr( 2)=-r7(12)+r6(7,1)-r5(5,3)-r5(12,8)*three+r4(2,2)+r4(7,10)*three &
&                     -r3(5,15)*three+r2(4,5)*three
              rrr( 3)=-r7(13)+r6(8,1)-r5(6,3)-r5(13,8)*three+r4(3,2)+r4(8,10)*three &
&                     -r3(6,15)*three+r2(5,5)*three
              rrr( 4)=-r7(17)+r6(11,1)-r5(8,3)-r5(8,8)-r5(17,8)+r4(4,2)+r4(4,10)+r4(11,10) &
&                     -r3(3,15)-r3(8,15)-r3(8,27)+r2(1,5)+r2(2,5)+r2(2,25)-r1(3,23)+r0(6)
              rrr( 5)=-r7(18)+r6(12,1)-r5(9,3)-r5(18,8)+r4(5,2)+r4(12,10)-r3(9,15)+r2(6,5)
              rrr( 6)=-r7(19)+r6(13,1)-r5(10,3)-r5(8,8)-r5(19,8)+r4(6,2)+r4(4,10)+r4(13,10) &
&                     -r3(3,15)-r3(10,15)-r3(8,27)+r2(1,5)+r2(3,5)+r2(2,25)-r1(3,23)+r0(6)
              rrr( 7)=-r7(23)+r6(16,1)-r5(12,3)-r5(12,8)*three+r4(7,2)+r4(7,10)*three &
&                     -r3(5,15)*three+r2(4,5)*three
              ...
              rrr(10)=-r7(26)+r6(19,1)-r5(15,3)-r5(13,8)*three+r4(10,2)+r4(8,10)*three &
&                     -r3(6,15)*three+r2(5,5)*three
...
&                     -r2(6,22)*three+r1(2,6)*three
              ...
              rxyz(37)=-r6(8,3)+r5(4,4)-r4(3,8)-r4(8,18)*three+r3(1,3)+r3(4,19)*three &
&                      -r2(5,21)*three+r1(1,5)*three
              rxyz(38)=-r6(8,4)+r5(4,5)-r4(3,9)-r4(8,19)*three+r3(1,4)+r3(4,20)*three &
&                      -r2(5,22)*three+r1(1,6)*three
...
&                     -r3(8,15)-r3(3,27)+r2(1,9)+r2(2,9)+r2(1,30)-r1(3,23)+r0(11)
              ...
              rrr( 6)=-r7(10)+r6(6,2)-r5(10,3)-r5(3,8)-r5(10,8)+r4(6,3)+r4(1,14)+r4(6,14) &
&                     -r3(3,15)-r3(10,15)-r3(3,27)+r2(1,9)+r2(3,9)+r2(1,30)-r1(3,23)+r0(11)
              rrr( 7)=-r7(12)+r6(7,2)-r5(12,3)-r5(5,8)*three+r4(7,3)+r4(2,14)*three &
&                     -r3(5,15)*three+r2(4,9)*three
              ...
              rrr(10)=-r7(15)+r6(10,2)-r5(15,3)-r5(6,8)*three+r4(10,3)+r4(3,14)*three &
&                     -r3(6,15)*three+r2(5,9)*three
...
&                     -r3(3,27)*three+r2(2,9)*six+r2(1,30)*three-r1(3,23)*three+r0(11)*three
              rrr(12)=-r7(18)+r6(12,2)-r5(18,3)-r5(9,8)*three+r4(12,3)+r4(5,14)*three &
&                     -r3(9,15)*three+r2(6,9)*three
              rrr(13)=-r7(19)+r6(13,2)-r5(19,3)-r5(8,8)-r5(10,8)+r4(13,3)+r4(4,14)+r4(6,14) &
&                     -r3(8,15)-r3(10,15)-r3(3,27)+r2(2,9)+r2(3,9)+r2(1,30)-r1(3,23)+r0(11)
              rrr(14)=-r7(20)+r6(14,2)-r5(20,3)-r5(9,8)*three+r4(14,3)+r4(5,14)*three &
&                     -r3(9,15)*three+r2(6,9)*three
...
&                     -r2(6,22)*three+r1(2,10)*three
              ...
              rxyz(37)=-r6(3,3)+r5(1,6)-r4(3,8)-r4(3,18)*three+r3(1,5)+r3(1,23)*three &
&                      -r2(5,21)*three+r1(1,9)*three
              rxyz(38)=-r6(3,4)+r5(1,7)-r4(3,9)-r4(3,19)*three+r3(1,6)+r3(1,24)*three &
&                      -r2(5,22)*three+r1(1,10)*three
              ...
              rxyz(44)=-r6(15,3)+r5(10,6)-r4(15,8)-r4(6,18)*three+r3(10,5)+r3(3,23)*three &
&                      -r2(3,21)*three+r1(3,9)*three
              rxyz(45)=-r6(15,4)+r5(10,7)-r4(15,9)-r4(6,19)*three+r3(10,6)+r3(3,24)*three &
...
&                     -r3(8,27)*three+r2(1,9)*six+r2(2,30)*three-r1(3,23)*three+r0(11)*three
              rrr( 2)=-r7(12)+r6(7,2)-r5(5,3)-r5(12,8)*three+r4(2,3)+r4(7,14)*three &
&                     -r3(5,15)*three+r2(4,9)*three
              rrr( 3)=-r7(13)+r6(8,2)-r5(6,3)-r5(13,8)*three+r4(3,3)+r4(8,14)*three &
&                     -r3(6,15)*three+r2(5,9)*three
              rrr( 4)=-r7(17)+r6(11,2)-r5(8,3)-r5(8,8)-r5(17,8)+r4(4,3)+r4(4,14)+r4(11,14) &
&                     -r3(3,15)-r3(8,15)-r3(8,27)+r2(1,9)+r2(2,9)+r2(2,30)-r1(3,23)+r0(11)
              rrr( 5)=-r7(18)+r6(12,2)-r5(9,3)-r5(18,8)+r4(5,3)+r4(12,14)-r3(9,15)+r2(6,9)
              rrr( 6)=-r7(19)+r6(13,2)-r5(10,3)-r5(8,8)-r5(19,8)+r4(6,3)+r4(4,14)+r4(13,14) &
&                     -r3(3,15)-r3(10,15)-r3(8,27)+r2(1,9)+r2(3,9)+r2(2,30)-r1(3,23)+r0(11)
              rrr( 7)=-r7(23)+r6(16,2)-r5(12,3)-r5(12,8)*three+r4(7,3)+r4(7,14)*three &
&                     -r3(5,15)*three+r2(4,9)*three
              ...
              rrr(10)=-r7(26)+r6(19,2)-r5(15,3)-r5(13,8)*three+r4(10,3)+r4(8,14)*three &
&                     -r3(6,15)*three+r2(5,9)*three
...
&                     -r2(6,22)*three+r1(2,10)*three
              ...
              rxyz(37)=-r6(8,3)+r5(4,6)-r4(3,8)-r4(8,18)*three+r3(1,5)+r3(4,23)*three &
&                      -r2(5,21)*three+r1(1,9)*three
              rxyz(38)=-r6(8,4)+r5(4,7)-r4(3,9)-r4(8,19)*three+r3(1,6)+r3(4,24)*three &
&                      -r2(5,22)*three+r1(1,10)*three
...
&                     +r4(1,1)+r4(1,2)*two+r4(1,3)+r4(6,10)*p12+r4(6,14)*six-r3(3,7)*six &
&                     -r3(3,11)*p12-r3(3,15)*p18-r3(10,27)*three+r2(1,1)*six+r2(1,5)*p12 &
&                     +r2(1,9)*six+r2(3,25)*six+r2(3,30)*three-r1(3,13)*three-r1(3,18)*six &
&                     -r1(3,23)*nine+r0(1)*three+r0(6)*six+r0(11)*three
              rrr( 2)=-r7(14)+r6(9,1)*two+r6(9,2)-r5(5,1)-r5(5,2)*two-r5(5,3)*three &
&                     -r5(14,8)*three+r4(2,1)+r4(2,2)*two+r4(2,3)+r4(9,10)*six+r4(9,14)*three &
&                     -r3(5,7)*three-r3(5,11)*six-r3(5,15)*nine+r2(4,1)*three+r2(4,5)*six &
&                     +r2(4,9)*three
              rrr( 3)=-r7(15)+r6(10,1)*two+r6(10,2)-r5(6,1)-r5(6,2)*two-r5(6,3)*three &
&                     -r5(15,8)*three+r4(3,1)+r4(3,2)*two+r4(3,3)+r4(10,10)*six &
&                     +r4(10,14)*three-r3(6,7)*three-r3(6,11)*six-r3(6,15)*nine+r2(5,1)*three &
&                     +r2(5,5)*six+r2(5,9)*three
...
&                     -r5(15,8)*three+r4(10,1)+r4(10,2)*two+r4(10,3)+r4(10,10)*six &
&                     +r4(10,14)*three-r3(6,7)*three-r3(6,11)*six-r3(6,15)*nine+r2(5,1)*three &
&                     +r2(5,5)*six+r2(5,9)*three
              rrr(11)=-r7(32)+r6(24,1)*two+r6(24,2)-r5(17,1)-r5(17,2)*two-r5(17,3)*three &
&                     -r5(19,8)*six+r4(11,1)+r4(11,2)*two+r4(11,3)+r4(13,10)*p12+r4(13,14)*six &
&                     -r3(8,7)*six-r3(8,11)*p12-r3(8,15)*p18-r3(10,27)*three+r2(2,1)*six &
&                     +r2(2,5)*p12+r2(2,9)*six+r2(3,25)*six+r2(3,30)*three-r1(3,13)*three &
&                     -r1(3,18)*six-r1(3,23)*nine+r0(1)*three+r0(6)*six+r0(11)*three
              rrr(12)=-r7(33)+r6(25,1)*two+r6(25,2)-r5(18,1)-r5(18,2)*two-r5(18,3)*three &
&                     -r5(20,8)*three+r4(12,1)+r4(12,2)*two+r4(12,3)+r4(14,10)*six &
&                     +r4(14,14)*three-r3(9,7)*three-r3(9,11)*six-r3(9,15)*nine+r2(6,1)*three &
&                     +r2(6,5)*six+r2(6,9)*three
              rrr(13)=-r7(34)+r6(26,1)*two+r6(26,2)-r5(19,1)-r5(19,2)*two-r5(19,3)*three-r5(19,8) &
&                     -r5(21,8)+r4(13,1)+r4(13,2)*two+r4(13,3)+r4(13,10)*two+r4(15,10)*two &
&                     +r4(13,14)+r4(15,14)-r3(8,7)-r3(10,7)-r3(8,11)*two-r3(10,11)*two &
&                     -r3(8,15)*three-r3(10,15)*three-r3(10,27)+r2(2,1)+r2(3,1)+r2(2,5)*two &
&                     +r2(3,5)*two+r2(2,9)+r2(3,9)+r2(3,25)*two+r2(3,30)-r1(3,13)-r1(3,18)*two &
&                     -r1(3,23)*three+r0(1)+r0(6)*two+r0(11)
              rrr(14)=-r7(35)+r6(27,1)*two+r6(27,2)-r5(20,1)-r5(20,2)*two-r5(20,3)*three &
&                     -r5(20,8)*three+r4(14,1)+r4(14,2)*two+r4(14,3)+r4(14,10)*six &
&                     +r4(14,14)*three-r3(9,7)*three-r3(9,11)*six-r3(9,15)*nine+r2(6,1)*three &
&                     +r2(6,5)*six+r2(6,9)*three
              rrr(15)=-r7(36)+r6(28,1)*two+r6(28,2)-r5(21,1)-r5(21,2)*two-r5(21,3)*three &
&                     -r5(21,8)*six+r4(15,1)+r4(15,2)*two+r4(15,3)+r4(15,10)*p12+r4(15,14)*six &
&                     -r3(10,7)*six-r3(10,11)*p12-r3(10,15)*p18-r3(10,27)*three+r2(3,1)*six &
&                     +r2(3,5)*p12+r2(3,9)*six+r2(3,25)*six+r2(3,30)*three-r1(3,13)*three &
&                     -r1(3,18)*six-r1(3,23)*nine+r0(1)*three+r0(6)*six+r0(11)*three
              rxyz(1)=-r3(10,31)+r2(3,29)*two+r2(3,34)-r1(3,17)-r1(3,22)*two-r1(3,27)*three &
&                     +r0(5)+r0(10)*two+r0(15)
...
&                     +r1(2,10)*three
              rxyz(9)=-r5(20,9)+r4(14,11)*two+r4(14,15)-r3(9,8)-r3(9,12)*two-r3(9,16)*three &
&                     +r2(6,2)+r2(6,6)*two+r2(6,10)
...
&                      -r2(3,18)*two-r2(3,22)*three+r1(3,2)+r1(3,6)*two+r1(3,10)
              rxyz(14)=-r6(19,4)+r5(13,5)*two+r5(13,7)-r4(8,5)-r4(8,7)*two-r4(8,9)*three &
&                      -r4(10,19)+r3(4,2)+r3(4,4)*two+r3(4,6)+r3(6,20)*two+r3(6,24)-r2(5,14) &
&                      -r2(5,18)*two-r2(5,22)*three+r1(1,2)+r1(1,6)*two+r1(1,10)
              rxyz(15)=-r6(19,3)+r5(13,4)*two+r5(13,6)-r4(8,4)-r4(8,6)*two-r4(8,8)*three &
&                      -r4(10,18)+r3(4,1)+r3(4,3)*two+r3(4,5)+r3(6,19)*two+r3(6,23)-r2(5,13) &
&                      -r2(5,17)*two-r2(5,21)*three+r1(1,1)+r1(1,5)*two+r1(1,9)
...
&                      -r2(6,18)*two-r2(6,22)*three+r1(2,2)+r1(2,6)*two+r1(2,10)
              rxyz(20)=-r5(15,9)+r4(10,11)*two+r4(10,15)-r3(6,8)-r3(6,12)*two-r3(6,16)*three &
&                      +r2(5,2)+r2(5,6)*two+r2(5,10)
              rxyz(21)=-r5(15,10)*two+r4(10,12)*four+r4(10,16)*two-r3(6,9)*two-r3(6,13)*four &
&                      -r3(6,17)*six+r2(5,3)*two+r2(5,7)*four+r2(5,11)*two
              rxyz(22)=-r5(15,11)+r4(10,13)*two+r4(10,17)-r3(6,10)-r3(6,14)*two-r3(6,18)*three &
&                      +r2(5,4)+r2(5,8)*two+r2(5,12)
              rxyz(23)=-r5(10,9)+r4(6,11)*two+r4(6,15)-r3(3,8)-r3(3,12)*two-r3(3,16)*three &
&                      -r3(10,28)+r2(1,2)+r2(1,6)*two+r2(1,10)+r2(3,26)*two+r2(3,31)-r1(3,14) &
&                      -r1(3,19)*two-r1(3,24)*three+r0(2)+r0(7)*two+r0(12)
              rxyz(24)=-r5(10,10)+r4(6,12)*two+r4(6,16)-r3(3,9)-r3(3,13)*two-r3(3,17)*three &
&                      -r3(10,29)+r2(1,3)+r2(1,7)*two+r2(1,11)+r2(3,27)*two+r2(3,32)-r1(3,15) &
&                      -r1(3,20)*two-r1(3,25)*three+r0(3)+r0(8)*two+r0(13)
              rxyz(25)=-r5(10,11)+r4(6,13)*two+r4(6,17)-r3(3,10)-r3(3,14)*two-r3(3,18)*three &
&                      -r3(10,30)+r2(1,4)+r2(1,8)*two+r2(1,12)+r2(3,28)*two+r2(3,33)-r1(3,16) &
&                      -r1(3,21)*two-r1(3,26)*three+r0(4)+r0(9)*two+r0(14)
              rxyz(26)=-r4(10,20)+r3(6,21)*two+r3(6,25)-r2(5,15)-r2(5,19)*two-r2(5,23)*three &
&                       +r1(1,3)+r1(1,7)*two+r1(1,11)
              rxyz(27)=-r4(10,21)+r3(6,22)*two+r3(6,26)-r2(5,16)-r2(5,20)*two-r2(5,24)*three &
&                       +r1(1,4)+r1(1,8)*two+r1(1,12)
              rxyz(28)=-r6(21,3)+r5(15,4)*two+r5(15,6)-r4(10,4)-r4(10,6)*two-r4(10,8)*three &
&                       -r4(10,18)+r3(6,1)+r3(6,3)*two+r3(6,5)+r3(6,19)*two+r3(6,23)-r2(5,13) &
&                       -r2(5,17)*two-r2(5,21)*three+r1(1,1)+r1(1,5)*two+r1(1,9)
              rxyz(29)=-r6(21,4)+r5(15,5)*two+r5(15,7)-r4(10,5)-r4(10,7)*two-r4(10,9)*three &
&                       -r4(10,19)+r3(6,2)+r3(6,4)*two+r3(6,6)+r3(6,20)*two+r3(6,24)-r2(5,14) &
&                       -r2(5,18)*two-r2(5,22)*three+r1(1,2)+r1(1,6)*two+r1(1,10)
              rxyz(30)=-r6(15,3)+r5(10,4)*two+r5(10,6)-r4(6,4)-r4(6,6)*two-r4(6,8)*three &
&                      -r4(15,18)+r3(3,1)+r3(3,3)*two+r3(3,5)+r3(10,19)*two+r3(10,23)-r2(3,13) &
&                      -r2(3,17)*two-r2(3,21)*three+r1(3,1)+r1(3,5)*two+r1(3,9)
              rxyz(31)=-r6(15,4)+r5(10,5)*two+r5(10,7)-r4(6,5)-r4(6,7)*two-r4(6,9)*three &
&                      -r4(15,19)+r3(3,2)+r3(3,4)*two+r3(3,6)+r3(10,20)*two+r3(10,24)-r2(3,14) &
&                      -r2(3,18)*two-r2(3,22)*three+r1(3,2)+r1(3,6)*two+r1(3,10)
...
&                      -r1(3,21)*two-r1(3,26)*three+r0(4)+r0(9)*two+r0(14)
              rxyz(35)=-r4(15,20)+r3(10,21)*two+r3(10,25)-r2(3,15)-r2(3,19)*two-r2(3,23)*three &
&                      +r1(3,3)+r1(3,7)*two+r1(3,11)
              rxyz(36)=-r4(15,21)+r3(10,22)*two+r3(10,26)-r2(3,16)-r2(3,20)*two-r2(3,24)*three &
&                      +r1(3,4)+r1(3,8)*two+r1(3,12)
              rxyz(37)=-r6(10,3)+r5(6,4)*two+r5(6,6)-r4(3,4)-r4(3,6)*two-r4(3,8)*three &
&                      -r4(10,18)*three+r3(1,1)+r3(1,3)*two+r3(1,5)+r3(6,19)*six+r3(6,23)*three &
&                      -r2(5,13)*three-r2(5,17)*six-r2(5,21)*nine+r1(1,1)*three+r1(1,5)*six &
&                      +r1(1,9)*three
              rxyz(38)=-r6(10,4)+r5(6,5)*two+r5(6,7)-r4(3,5)-r4(3,7)*two-r4(3,9)*three &
&                      -r4(10,19)*three+r3(1,2)+r3(1,4)*two+r3(1,6)+r3(6,20)*six &
&                      +r3(6,24)*three-r2(5,14)*three-r2(5,18)*six-r2(5,22)*nine+r1(1,2)*three &
&                      +r1(1,6)*six+r1(1,10)*three
...
&                      +r3(5,4)*two+r3(5,6)
              rxyz(41)=-r5(14,9)+r4(9,11)*two+r4(9,15)-r3(5,8)-r3(5,12)*two-r3(5,16)*three &
&                      +r2(4,2)+r2(4,6)*two+r2(4,10)
              rxyz(42)=-r5(14,10)+r4(9,12)*two+r4(9,16)-r3(5,9)-r3(5,13)*two-r3(5,17)*three &
&                      +r2(4,3)+r2(4,7)*two+r2(4,11)
              rxyz(43)=-r5(14,11)+r4(9,13)*two+r4(9,17)-r3(5,10)-r3(5,14)*two-r3(5,18)*three &
&                      +r2(4,4)+r2(4,8)*two+r2(4,12)
              rxyz(44)=-r6(28,3)+r5(21,4)*two+r5(21,6)-r4(15,4)-r4(15,6)*two-r4(15,8)*three &
&                      -r4(15,18)*three+r3(10,1)+r3(10,3)*two+r3(10,5)+r3(10,19)*six &
&                      +r3(10,23)*three-r2(3,13)*three-r2(3,17)*six-r2(3,21)*nine+r1(3,1)*three &
&                      +r1(3,5)*six+r1(3,9)*three
              rxyz(45)=-r6(28,4)+r5(21,5)*two+r5(21,7)-r4(15,5)-r4(15,7)*two-r4(15,9)*three &
&                      -r4(15,19)*three+r3(10,2)+r3(10,4)*two+r3(10,6)+r3(10,20)*six &
&                      +r3(10,24)*three-r2(3,14)*three-r2(3,18)*six-r2(3,22)*nine+r1(3,2)*three &
&                      +r1(3,6)*six+r1(3,10)*three
            case(16)
            ...
            case(17)
              rrr( 1)=-r7(6)+r6(3,1)+r6(3,2)-r5(1,2)-r5(1,3)-r5(6,8)*six+r4(3,10)*six &
&                     +r4(3,14)*six-r3(1,11)*six-r3(1,15)*six-r3(6,27)*three+r2(5,25)*three &
...
&                     -r3(5,15)
              rrr( 6)=-r7(15)+r6(10,1)+r6(10,2)-r5(6,2)-r5(6,3)-r5(6,8)-r5(15,8)+r4(3,10) &
&                     +r4(10,10)+r4(3,14)+r4(10,14)-r3(1,11)-r3(6,11)-r3(1,15)-r3(6,15)-r3(6,27) &
&                     +r2(5,25)+r2(5,30)-r1(1,18)-r1(1,23)
              rrr( 7)=-r7(18)+r6(12,1)+r6(12,2)-r5(7,2)-r5(7,3)-r5(9,8)*three+r4(5,10)*three &
&                     +r4(5,14)*three-r3(2,11)*three-r3(2,15)*three
              rrr( 8)=-r7(19)+r6(13,1)+r6(13,2)-r5(8,2)-r5(8,3)-r5(10,8)+r4(6,10)+r4(6,14) &
&                     -r3(3,11)-r3(3,15)
              rrr( 9)=-r7(20)+r6(14,1)+r6(14,2)-r5(9,2)-r5(9,3)-r5(9,8)+r4(5,10)+r4(5,14) &
&                     -r3(2,11)-r3(2,15)
...
&                      -r1(1,21)-r1(1,26)
              ...
              rxyz(28)=-r6(15,3)+r5(10,4)+r5(10,6)-r4(6,6)-r4(6,8)-r4(6,18)+r3(3,19)+r3(3,23) &
&                      -r2(1,17)-r2(1,21)
              rxyz(29)=-r6(15,4)+r5(10,5)+r5(10,7)-r4(6,7)-r4(6,9)-r4(6,19)+r3(3,20)+r3(3,24) &
&                      -r2(1,18)-r2(1,22)
              rxyz(30)=-r6(10,3)+r5(6,4)+r5(6,6)-r4(3,6)-r4(3,8)-r4(10,18)+r3(6,19)+r3(6,23) &
&                      -r2(5,17)-r2(5,21)
              rxyz(31)=-r6(10,4)+r5(6,5)+r5(6,7)-r4(3,7)-r4(3,9)-r4(10,19)+r3(6,20)+r3(6,24) &
&                      -r2(5,18)-r2(5,22)
              rxyz(32)=-r5(15,9)+r4(10,11)+r4(10,15)-r3(6,12)-r3(6,16)-r3(6,28)+r2(5,26) &
&                      +r2(5,31)-r1(1,19)-r1(1,24)
              rxyz(33)=-r5(15,10)+r4(10,12)+r4(10,16)-r3(6,13)-r3(6,17)-r3(6,29)+r2(5,27) &
&                      +r2(5,32)-r1(1,20)-r1(1,25)
              rxyz(34)=-r5(15,11)+r4(10,13)+r4(10,17)-r3(6,14)-r3(6,18)-r3(6,30)+r2(5,28) &
&                      +r2(5,33)-r1(1,21)-r1(1,26)
...
&                      +r3(3,24)*three-r2(1,18)*three-r2(1,22)*three
              ...
              rxyz(44)=-r6(21,3)+r5(15,4)+r5(15,6)-r4(10,6)-r4(10,8)-r4(10,18)*three &
&                      +r3(6,19)*three+r3(6,23)*three-r2(5,17)*three-r2(5,21)*three
              rxyz(45)=-r6(21,4)+r5(15,5)+r5(15,7)-r4(10,7)-r4(10,9)-r4(10,19)*three &
&                      +r3(6,20)*three+r3(6,24)*three-r2(5,18)*three-r2(5,22)*three
            case(18)
              rrr( 1)=-r7(9)+r6(5,1)+r6(5,2)-r5(2,2)-r5(2,3)-r5(9,8)*six+r4(5,10)*six &
&                     +r4(5,14)*six-r3(2,11)*six-r3(2,15)*six-r3(9,27)*three+r2(6,25)*three &
...
&                     +r4(9,14)*three-r3(5,11)*three-r3(5,15)*three
              rrr( 4)=-r7(18)+r6(12,1)+r6(12,2)-r5(7,2)-r5(7,3)-r5(9,8)-r5(18,8)+r4(5,10) &
&                     +r4(12,10)+r4(5,14)+r4(12,14)-r3(2,11)-r3(7,11)-r3(2,15)-r3(7,15) &
&                     -r3(9,27)+r2(6,25)+r2(6,30)-r1(2,18)-r1(2,23)
              rrr( 5)=-r7(19)+r6(13,1)+r6(13,2)-r5(8,2)-r5(8,3)-r5(19,8)+r4(13,10)+r4(13,14) &
&                     -r3(8,11)-r3(8,15)
              rrr( 6)=-r7(20)+r6(14,1)+r6(14,2)-r5(9,2)-r5(9,3)-r5(9,8)-r5(20,8)+r4(5,10) &
&                     +r4(14,10)+r4(5,14)+r4(14,14)-r3(2,11)-r3(9,11)-r3(2,15)-r3(9,15) &
&                     -r3(9,27)+r2(6,25)+r2(6,30)-r1(2,18)-r1(2,23)
              rrr( 7)=-r7(24)+r6(17,1)+r6(17,2)-r5(11,2)-r5(11,3)-r5(13,8)*three+r4(8,10)*three &
&                     +r4(8,14)*three-r3(4,11)*three-r3(4,15)*three
              rrr( 8)=-r7(25)+r6(18,1)+r6(18,2)-r5(12,2)-r5(12,3)-r5(14,8)+r4(9,10)+r4(9,14) &
&                     -r3(5,11)-r3(5,15)
              rrr( 9)=-r7(26)+r6(19,1)+r6(19,2)-r5(13,2)-r5(13,3)-r5(13,8)+r4(8,10)+r4(8,14) &
&                     -r3(4,11)-r3(4,15)
...
&                     -r1(2,20)-r1(2,25)
              rxyz(7)=-r6(24,3)+r5(17,4)+r5(17,6)-r4(11,6)-r4(11,8)-r4(13,18)*three &
&                     +r3(8,19)*three+r3(8,23)*three-r2(2,17)*three-r2(2,21)*three
              rxyz(8)=-r6(24,4)+r5(17,5)+r5(17,7)-r4(11,7)-r4(11,9)-r4(13,19)*three &
&                     +r3(8,20)*three+r3(8,24)*three-r2(2,18)*three-r2(2,22)*three
...
&                      -r1(2,21)-r1(2,26)
              ...
              rxyz(28)=-r6(20,3)+r5(14,4)+r5(14,6)-r4(9,6)-r4(9,8)-r4(9,18)+r3(5,19)+r3(5,23) &
&                      -r2(4,17)-r2(4,21)
              rxyz(29)=-r6(20,4)+r5(14,5)+r5(14,7)-r4(9,7)-r4(9,9)-r4(9,19)+r3(5,20)+r3(5,24) &
&                      -r2(4,18)-r2(4,22)
              rxyz(30)=-r6(14,3)+r5(9,4)+r5(9,6)-r4(5,6)-r4(5,8)-r4(14,18)+r3(9,19)+r3(9,23) &
&                      -r2(6,17)-r2(6,21)
              rxyz(31)=-r6(14,4)+r5(9,5)+r5(9,7)-r4(5,7)-r4(5,9)-r4(14,19)+r3(9,20)+r3(9,24) &
&                      -r2(6,18)-r2(6,22)
              rxyz(32)=-r5(20,9)+r4(14,11)+r4(14,15)-r3(9,12)-r3(9,16)-r3(9,28)+r2(6,26) &
&                      +r2(6,31)-r1(2,19)-r1(2,24)
              rxyz(33)=-r5(20,10)+r4(14,12)+r4(14,16)-r3(9,13)-r3(9,17)-r3(9,29)+r2(6,27) &
&                      +r2(6,32)-r1(2,20)-r1(2,25)
              rxyz(34)=-r5(20,11)+r4(14,13)+r4(14,17)-r3(9,14)-r3(9,18)-r3(9,30)+r2(6,28) &
&                      +r2(6,33)-r1(2,21)-r1(2,26)
...
&                      +r3(5,24)*three-r2(4,18)*three-r2(4,22)*three
              ...
              rxyz(44)=-r6(27,3)+r5(20,4)+r5(20,6)-r4(14,6)-r4(14,8)-r4(14,18)*three &
&                      +r3(9,19)*three+r3(9,23)*three-r2(6,17)*three-r2(6,21)*three
              rxyz(45)=-r6(27,4)+r5(20,5)+r5(20,7)-r4(14,7)-r4(14,9)-r4(14,19)*three &
&                      +r3(9,20)*three+r3(9,24)*three-r2(6,18)*three-r2(6,22)*three
            end select
            eri(1,1,j,i)=rrr( 1)+(rxyz(37)+rxyz(38))*two*qx+(rxyz(23)+rxyz(24)*four+rxyz(25))*xx &
&                        +(rxyz(26)+rxyz(27))*two*xxx+rxyz(1)*xxxx
            eri(2,1,j,i)=rrr( 4)+rxyz(14)*two*qx+rxyz(5)*xx
            eri(3,1,j,i)=rrr( 6)+rxyz(29)*two*qx+rxyz(30)*two*qz+rxyz(34)*xx+rxyz(21)*two*xz &
&                        +rxyz(23)*zz+rxyz(36)*two*xxz+rxyz(26)*two*xzz+rxyz(1)*xxzz
            eri(4,1,j,i)=rrr( 2)+(rxyz(16)*two+rxyz(17))*qx+(rxyz(42)*two+rxyz(43))*xx+rxyz(2)*xxx
            eri(5,1,j,i)=rrr( 3)+(rxyz(30)+rxyz(31)*two)*qx+rxyz(37)*qz+(rxyz(21)+rxyz(22))*xx &
&                        +(rxyz(23)+rxyz(24)*two)*xz+rxyz(36)*xxx+(rxyz(26)*two+rxyz(27))*xxz &
&                        +rxyz(1)*xxxz
            eri(6,1,j,i)=rrr( 5)+rxyz(40)*two*qx+rxyz(17)*qz+rxyz(11)*xx+rxyz(42)*two*xz &
&                        +rxyz(2)*xxz
            ...
            eri(1,3,j,i)=rrr( 6)+rxyz(28)*two*qx+rxyz(31)*two*qz+rxyz(32)*xx+rxyz(21)*two*xz &
&                        +rxyz(25)*zz+rxyz(35)*two*xxz+rxyz(27)*two*xzz+rxyz(1)*xxzz
            eri(2,3,j,i)=rrr(13)+rxyz(13)*two*qz+rxyz(5)*zz
            eri(3,3,j,i)=rrr(15)+(rxyz(44)+rxyz(45))*two*qz+(rxyz(32)+rxyz(33)*four+rxyz(34))*zz &
&                        +(rxyz(35)+rxyz(36))*two*zzz+rxyz(1)*zzzz
            eri(4,3,j,i)=rrr( 9)+rxyz(18)*qx+rxyz(40)*two*qz+rxyz(10)*two*xz+rxyz(43)*zz &
&                        +rxyz(2)*xzz
            eri(5,3,j,i)=rrr(10)+rxyz(44)*qx+(rxyz(28)+rxyz(29)*two)*qz+(rxyz(32) &
&                        +rxyz(33)*two)*xz+(rxyz(21)+rxyz(22))*zz+(rxyz(35)*two+rxyz(36))*xzz &
&                        +rxyz(27)*zzz+rxyz(1)*xzzz
            eri(6,3,j,i)=rrr(14)+(rxyz(18)+rxyz(19)*two)*qz+(rxyz(10)*two+rxyz(11))*zz+rxyz(2)*zzz
            eri(1,4,j,i)=rrr( 2)+(rxyz(16)+rxyz(17)*two)*qx+(rxyz(41)+rxyz(42)*two)*xx+rxyz(3)*xxx
            eri(2,4,j,i)=rrr( 7)+rxyz(8)*qx
            eri(3,4,j,i)=rrr( 9)+rxyz(19)*qx+rxyz(39)*two*qz+rxyz(10)*two*xz+rxyz(41)*zz &
&                        +rxyz(3)*xzz
            eri(4,4,j,i)=rrr( 4)+(rxyz(14)+rxyz(15))*qx+rxyz(6)*xx
            eri(5,4,j,i)=rrr( 5)+(rxyz(39)+rxyz(40))*qx+rxyz(17)*qz+rxyz(10)*xx+(rxyz(41) &
&                        +rxyz(42))*xz+rxyz(3)*xxz
            eri(6,4,j,i)=rrr( 8)+rxyz(13)*qx+rxyz(15)*qz+rxyz(6)*xz
            eri(1,5,j,i)=rrr( 3)+(rxyz(30)*two+rxyz(31))*qx+rxyz(38)*qz+(rxyz(20)+rxyz(21))*xx &
&                        +(rxyz(24)*two+rxyz(25))*xz+rxyz(35)*xxx+(rxyz(26)+rxyz(27)*two)*xxz &
&                        +rxyz(1)*xxxz
            eri(2,5,j,i)=rrr( 8)+rxyz(13)*qx+rxyz(14)*qz+rxyz(5)*xz
            eri(3,5,j,i)=rrr(10)+rxyz(45)*qx+(rxyz(28)*two+rxyz(29))*qz+(rxyz(33)*two &
&                        +rxyz(34))*xz+(rxyz(20)+rxyz(21))*zz+(rxyz(35)+rxyz(36)*two)*xzz &
&                        +rxyz(26)*zzz+rxyz(1)*xzzz
            eri(4,5,j,i)=rrr( 5)+(rxyz(39)+rxyz(40))*qx+rxyz(16)*qz+rxyz(10)*xx+(rxyz(42) &
&                        +rxyz(43))*xz+rxyz(2)*xxz
            eri(5,5,j,i)=rrr( 6)+(rxyz(28)+rxyz(29))*qx+(rxyz(30)+rxyz(31))*qz+rxyz(33)*xx &
&                        +(rxyz(20)+rxyz(21)+rxyz(22))*xz+rxyz(24)*zz+(rxyz(35)+rxyz(36))*xxz &
&                        +(rxyz(26)+rxyz(27))*xzz+rxyz(1)*xxzz
            eri(6,5,j,i)=rrr( 9)+rxyz(19)*qx+(rxyz(39)+rxyz(40))*qz+(rxyz(10)+rxyz(11))*xz &
&                        +rxyz(42)*zz+rxyz(2)*xzz
            eri(1,6,j,i)=rrr( 5)+rxyz(39)*two*qx+rxyz(16)*qz+rxyz(9)*xx+rxyz(42)*two*xz &
&                        +rxyz(3)*xxz
            eri(2,6,j,i)=rrr(12)+rxyz(8)*qz
            eri(3,6,j,i)=rrr(14)+(rxyz(18)*two+rxyz(19))*qz+(rxyz(9)+rxyz(10)*two)*zz+rxyz(3)*zzz
            eri(4,6,j,i)=rrr( 8)+rxyz(12)*qx+rxyz(14)*qz+rxyz(6)*xz
            eri(5,6,j,i)=rrr( 9)+rxyz(18)*qx+(rxyz(39)+rxyz(40))*qz+(rxyz(9)+rxyz(10))*xz &
&                        +rxyz(42)*zz+rxyz(3)*xzz
