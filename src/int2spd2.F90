...
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,1,1)
!
      ...
      rxyz(45)=+r3(4,15)
      call int2ddpp1(eri,rrr,rxyz,qx,qz,2,1)
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,3,1)
!
      do i= 1,6
        do j= 1,6
...
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,2,2)
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,3,2)
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,1,3)
!
      ...
      call int2ddpp1(eri,rrr,rxyz,qx,qz,2,3)
!
      rrr( 1)= r6(6)-r5(3,1)-r5(3,2)+r4(1,1)+r4(1,2)+r4(6,7)*six-r3(3,5)*six-r3(3,9)*six &
&          +r2(1,1)*six+r2(1,5)*six+r2(3,17)*three-r1(3,9)*three-r1(3,14)*three+r0(1)*three &
&          +r0(6)*three
...
&          -r3(3,9)-r3(8,9)+r2(1,1)+r2(2,1)+r2(1,5)+r2(2,5)+r2(3,17)-r1(3,9)-r1(3,14)+r0(1)+r0(6)
...
&          -r3(3,9)-r3(10,9)+r2(1,1)+r2(3,1)+r2(1,5)+r2(3,5)+r2(3,17)-r1(3,9)-r1(3,14)+r0(1)+r0(6)
      rrr( 7)= r6(18)-r5(12,1)-r5(12,2)+r4(7,1)+r4(7,2)+r4(9,7)*three-r3(5,5)*three &
&          -r3(5,9)*three+r2(4,1)*three+r2(4,5)*three
      rrr( 8)= r6(19)-r5(13,1)-r5(13,2)+r4(8,1)+r4(8,2)+r4(10,7)-r3(6,5)-r3(6,9)+r2(5,1)+r2(5,5)
      rrr( 9)= r6(20)-r5(14,1)-r5(14,2)+r4(9,1)+r4(9,2)+r4(9,7)-r3(5,5)-r3(5,9)+r2(4,1)+r2(4,5)
...
&          -r3(8,9)*six+r2(2,1)*six+r2(2,5)*six+r2(3,17)*three-r1(3,9)*three-r1(3,14)*three &
...
&          -r3(9,9)*three+r2(6,1)*three+r2(6,5)*three
      rrr(13)= r6(26)-r5(19,1)-r5(19,2)+r4(13,1)+r4(13,2)+r4(13,7)+r4(15,7)-r3(8,5)-r3(10,5) &
&          -r3(8,9)-r3(10,9)+r2(2,1)+r2(3,1)+r2(2,5)+r2(3,5)+r2(3,17)-r1(3,9)-r1(3,14)+r0(1)+r0(6)
...
&          -r3(10,9)*six+r2(3,1)*six+r2(3,5)*six+r2(3,17)*three-r1(3,9)*three-r1(3,14)*three &
&          +r0(1)*three+r0(6)*three
...
&              -r2(5,14)*three+r1(1,2)*three+r1(1,6)*three
      rxyz( 3)=+r4(6,8)-r3(3,6)-r3(3,10)+r2(1,2)+r2(1,6)+r2(3,18)-r1(3,10)-r1(3,15)+r0(2)+r0(7)
      rxyz( 4)=+r4(6,9)-r3(3,7)-r3(3,11)+r2(1,3)+r2(1,7)+r2(3,19)-r1(3,11)-r1(3,16)+r0(3)+r0(8)
      rxyz( 5)=+r4(6,10)-r3(3,8)-r3(3,12)+r2(1,4)+r2(1,8)+r2(3,20)-r1(3,12)-r1(3,17)+r0(4)+r0(9)
      ...
      rxyz( 9)=+r5(13,3)-r4(8,3)-r4(8,5)+r3(4,1)+r3(4,3)+r3(6,13)-r2(5,9)-r2(5,13)+r1(1,1) &
&              +r1(1,5)
      rxyz(10)=+r5(13,4)-r4(8,4)-r4(8,6)+r3(4,2)+r3(4,4)+r3(6,14)-r2(5,10)-r2(5,14)+r1(1,2) &
&              +r1(1,6)
      rxyz(11)=+r4(13,10)-r3(8,8)-r3(8,12)+r2(2,4)+r2(2,8)+r2(3,20)-r1(3,12)-r1(3,17)+r0(4)+r0(9)
      rxyz(12)=+r5(15,3)-r4(10,3)-r4(10,5)+r3(6,1)+r3(6,3)+r3(6,13)-r2(5,9)-r2(5,13)+r1(1,1) &
&              +r1(1,5)
      rxyz(13)=+r5(15,4)-r4(10,4)-r4(10,6)+r3(6,2)+r3(6,4)+r3(6,14)-r2(5,10)-r2(5,14)+r1(1,2) &
&              +r1(1,6)
      rxyz(14)=+r5(10,3)-r4(6,3)-r4(6,5)+r3(3,1)+r3(3,3)+r3(10,13)-r2(3,9)-r2(3,13)+r1(3,1) &
&              +r1(3,5)
      rxyz(15)=+r5(10,4)-r4(6,4)-r4(6,6)+r3(3,2)+r3(3,4)+r3(10,14)-r2(3,10)-r2(3,14)+r1(3,2) &
&              +r1(3,6)
...
&              +r0(4)+r0(9)
      ...
      rxyz(24)=+r5(9,3)-r4(5,3)-r4(5,5)+r3(2,1)+r3(2,3)+r3(9,13)-r2(6,9)-r2(6,13)+r1(2,1)+r1(2,5)
      rxyz(25)=+r5(9,4)-r4(5,4)-r4(5,6)+r3(2,2)+r3(2,4)+r3(9,14)-r2(6,10)-r2(6,14)+r1(2,2)+r1(2,6)
      ...
      rxyz(35)=+r4(13,8)-r3(8,6)-r3(8,10)+r2(2,2)+r2(2,6)+r2(3,18)-r1(3,10)-r1(3,15)+r0(2)+r0(7)
      rxyz(36)=+r5(19,3)-r4(13,3)-r4(13,5)+r3(8,1)+r3(8,3)+r3(10,13)-r2(3,9)-r2(3,13)+r1(3,1) &
&              +r1(3,5)
      rxyz(37)=+r5(19,4)-r4(13,4)-r4(13,6)+r3(8,2)+r3(8,4)+r3(10,14)-r2(3,10)-r2(3,14)+r1(3,2) &
&              +r1(3,6)
...
&              -r2(6,14)*three+r1(2,2)*three+r1(2,6)*three
      rxyz(40)=+r5(21,3)-r4(15,3)-r4(15,5)+r3(10,1)+r3(10,3)+r3(10,13)*three-r2(3,9)*three &
&              -r2(3,13)*three+r1(3,1)*three+r1(3,5)*three
      rxyz(41)=+r5(21,4)-r4(15,4)-r4(15,6)+r3(10,2)+r3(10,4)+r3(10,14)*three-r2(3,10)*three &
&              -r2(3,14)*three+r1(3,2)*three+r1(3,6)*three
      rxyz(42)=+r5(20,3)-r4(14,3)-r4(14,5)+r3(9,1)+r3(9,3)+r3(9,13)-r2(6,9)-r2(6,13)+r1(2,1) &
&              +r1(2,5)
      rxyz(43)=+r5(20,4)-r4(14,4)-r4(14,6)+r3(9,2)+r3(9,4)+r3(9,14)-r2(6,10)-r2(6,14)+r1(2,2) &
&              +r1(2,6)
      rxyz(44)=+r4(13,9)-r3(8,7)-r3(8,11)+r2(2,3)+r2(2,7)+r2(3,19)-r1(3,11)-r1(3,16)+r0(3)+r0(8)
      rxyz(45)=+r3(9,15)-r2(6,11)-r2(6,15)+r1(2,3)+r1(2,7)
      call int2ddpp1(eri,rrr,rxyz,qx,qz,3,3)
!
...
!-----------------------------------------------
  subroutine int2ddpp1(eri,rrr,rxyz,qx,qz,i,j)
!-----------------------------------------------
      implicit none
      integer,intent(in) :: i, j
      real(8),parameter :: two=2.0D+00, four=4.0D+00
      real(8),intent(out) :: eri(6,6,3,3)
...
!
      ...
      zzzz= zz*zz
!
      eri(1,1,i,j)=rrr(1)+(rxyz(1)+rxyz(2))*two*qx+(rxyz(3)+rxyz(4)*four+rxyz(5))*xx &
&                  +(rxyz(6)+rxyz(7))*two*xxx+rxyz(8)*xxxx
      eri(2,1,i,j)=rrr(4)+rxyz(10)*two*qx+rxyz(11)*xx
      eri(3,1,i,j)=rrr(6)+rxyz(13)*two*qx+rxyz(14)*two*qz+rxyz(18)*xx+rxyz(20)*two*xz &
&                  +rxyz(3)*zz+rxyz(23)*two*xxz+rxyz(6)*two*xzz+rxyz(8)*xxzz
      eri(4,1,i,j)=rrr(2)+(rxyz(24)+rxyz(25)*two)*qx+(rxyz(27)*two+rxyz(28))*xx &
&                  +rxyz(29)*xxx
      eri(5,1,i,j)=rrr(3)+(rxyz(14)+rxyz(15)*two)*qx+rxyz(1)*qz+(rxyz(20)+rxyz(21))*xx &
&                  +(rxyz(3)+rxyz(4)*two)*xz+rxyz(23)*xxx+(rxyz(6)*two+rxyz(7))*xxz+rxyz(8)*xxxz
      eri(6,1,i,j)=rrr(5)+rxyz(31)*two*qx+rxyz(24)*qz+rxyz(34)*xx+rxyz(27)*two*xz+rxyz(29)*xxz
      eri(1,2,i,j)=rrr(4)+rxyz(9)*two*qx+rxyz(35)*xx
      eri(2,2,i,j)=rrr(11)
      eri(3,2,i,j)=rrr(13)+rxyz(36)*two*qz+rxyz(35)*zz
      eri(4,2,i,j)=rrr(7)+rxyz(38)*qx
      eri(5,2,i,j)=rrr(8)+rxyz(36)*qx+rxyz(9)*qz+rxyz(35)*xz
      eri(6,2,i,j)=rrr(12)+rxyz(38)*qz
      eri(1,3,i,j)=rrr(6)+rxyz(12)*two*qx+rxyz(15)*two*qz+rxyz(16)*xx+rxyz(20)*two*xz &
&                  +rxyz(5)*zz+rxyz(22)*two*xxz+rxyz(7)*two*xzz+rxyz(8)*xxzz
      eri(2,3,i,j)=rrr(13)+rxyz(37)*two*qz+rxyz(11)*zz
      eri(3,3,i,j)=rrr(15)+(rxyz(40)+rxyz(41))*two*qz+(rxyz(16)+rxyz(17)*four+rxyz(18)) &
&                  *zz+(rxyz(22)+rxyz(23))*two*zzz+rxyz(8)*zzzz
      eri(4,3,i,j)=rrr(9)+rxyz(42)*qx+rxyz(31)*two*qz+rxyz(33)*two*xz+rxyz(28)*zz+rxyz(29)*xzz
      eri(5,3,i,j)=rrr(10)+rxyz(40)*qx+(rxyz(12)+rxyz(13)*two)*qz+(rxyz(16)+rxyz(17)*two)*xz &
&                  +(rxyz(20)+rxyz(21))*zz+(rxyz(22)*two+rxyz(23))*xzz+rxyz(7)*zzz+rxyz(8)*xzzz
      eri(6,3,i,j)=rrr(14)+(rxyz(42)+rxyz(43)*two)*qz+(rxyz(33)*two+rxyz(34))*zz+rxyz(29)*zzz
      eri(1,4,i,j)=rrr(2)+(rxyz(24)*two+rxyz(25))*qx+(rxyz(26)+rxyz(27)*two)*xx+rxyz(45)*xxx
      eri(2,4,i,j)=rrr(7)+rxyz(39)*qx
      eri(3,4,i,j)=rrr(9)+rxyz(43)*qx+rxyz(30)*two*qz+rxyz(33)*two*xz+rxyz(26)*zz+rxyz(45)*xzz
      eri(4,4,i,j)=rrr(4)+(rxyz(9)+rxyz(10))*qx+rxyz(44)*xx
      eri(5,4,i,j)=rrr(5)+(rxyz(30)+rxyz(31))*qx+rxyz(24)*qz+rxyz(33)*xx+(rxyz(26)+rxyz(27))*xz &
&                  +rxyz(45)*xxz
      eri(6,4,i,j)=rrr(8)+rxyz(37)*qx+rxyz(9)*qz+rxyz(44)*xz
      eri(1,5,i,j)=rrr(3)+(rxyz(14)*two+rxyz(15))*qx+rxyz(2)*qz+(rxyz(19)+rxyz(20))*xx &
&                  +(rxyz(4)*two+rxyz(5))*xz+rxyz(22)*xxx+(rxyz(6)+rxyz(7)*two)*xxz+rxyz(8)*xxxz
      eri(2,5,i,j)=rrr(8)+rxyz(37)*qx+rxyz(10)*qz+rxyz(11)*xz
      eri(3,5,i,j)=rrr(10)+rxyz(41)*qx+(rxyz(12)*two+rxyz(13))*qz+(rxyz(17)*two+rxyz(18))*xz &
&                  +(rxyz(19)+rxyz(20))*zz+(rxyz(22)+rxyz(23)*two)*xzz+rxyz(6)*zzz+rxyz(8)*xzzz
      eri(4,5,i,j)=rrr(5)+(rxyz(30)+rxyz(31))*qx+rxyz(25)*qz+rxyz(33)*xx+(rxyz(27)+rxyz(28))*xz &
&                  +rxyz(29)*xxz
      eri(5,5,i,j)=rrr(6)+(rxyz(12)+rxyz(13))*qx+(rxyz(14)+rxyz(15))*qz+rxyz(17)*xx &
&                  +(rxyz(19)+rxyz(20)+rxyz(21))*xz+rxyz(4)*zz+(rxyz(22)+rxyz(23))*xxz &
&                  +(rxyz(6)+rxyz(7))*xzz+rxyz(8)*xxzz
      eri(6,5,i,j)=rrr(9)+rxyz(43)*qx+(rxyz(30)+rxyz(31))*qz+(rxyz(33)+rxyz(34))*xz &
&                  +rxyz(27)*zz+rxyz(29)*xzz
      eri(1,6,i,j)=rrr(5)+rxyz(30)*two*qx+rxyz(25)*qz+rxyz(32)*xx+rxyz(27)*two*xz+rxyz(45)*xxz
      eri(2,6,i,j)=rrr(12)+rxyz(39)*qz
      eri(3,6,i,j)=rrr(14)+(rxyz(42)*two+rxyz(43))*qz+(rxyz(32)+rxyz(33)*two)*zz+rxyz(45)*zzz
      eri(4,6,i,j)=rrr(8)+rxyz(36)*qx+rxyz(10)*qz+rxyz(44)*xz
      eri(5,6,i,j)=rrr(9)+rxyz(42)*qx+(rxyz(30)+rxyz(31))*qz+(rxyz(32)+rxyz(33))*xz+rxyz(27)*zz &
&                  +rxyz(45)*xzz
      eri(6,6,i,j)=rrr(13)+(rxyz(36)+rxyz(37))*qz+rxyz(44)*zz
!
      return
end
...
!
      ...
      eri(1,1,1,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,1,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,1,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,1,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,1,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,1,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,1,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,1,1)=+rrr(7)
      eri(3,2,1,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,1,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,1,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,1,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,1,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,1,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,1,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,1,1)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,1,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,1,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      ...
      eri(1,1,2,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,2,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,2,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,2,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,2,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,2,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,2,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,2,1)=+rrr(7)
      eri(3,2,2,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,2,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,2,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,2,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,2,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,2,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,2,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,2,1)=rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,2,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,2,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             -r2(5,7)*three-r2(5,13)*three
      ...
      rxyz( 6)=-r5(13,4)+r4(8,5)*two-r3(4,5)-r3(4,9)-r3(6,17)+r2(5,17)*two-r1(1,11)-r1(1,17)
      rxyz( 7)=-r5(15,3)+r4(10,4)*two-r3(6,4)-r3(6,8)-r3(6,16)+r2(5,16)*two-r1(1,10)-r1(1,16)
      rxyz( 8)=-r5(15,4)+r4(10,5)*two-r3(6,5)-r3(6,9)-r3(6,17)+r2(5,17)*two-r1(1,11)-r1(1,17)
      ...
      rxyz(19)=-r5(13,3)+r4(8,4)*two-r3(4,4)-r3(4,8)-r3(6,16)+r2(5,16)*two-r1(1,10)-r1(1,16)
      eri(1,1,3,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,3,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,3,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,3,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,3,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,3,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,3,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,3,1)=+rrr(7)
      eri(3,2,3,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,3,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,3,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,3,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,3,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,3,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,3,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,3,1)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,3,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,3,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      ...
      eri(1,1,4,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,4,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,4,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,4,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,4,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,4,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,4,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,4,1)=+rrr(7)
      eri(3,2,4,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,4,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,4,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,4,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,4,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,4,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,4,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,4,1)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,4,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,4,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             -r2(3,13)*three+r1(3,4)*three
      ...
      eri(1,1,5,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,5,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,5,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,5,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,5,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,5,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,5,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,5,1)=+rrr(7)
      eri(3,2,5,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,5,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,5,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,5,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,5,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,5,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,5,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,5,1)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,5,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,5,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      ...
      eri(1,1,6,1)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,6,1)=+rrr(4)+rxyz(6)*qx
      eri(3,1,6,1)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,6,1)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,6,1)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,6,1)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,6,1)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,6,1)=+rrr(7)
      eri(3,2,6,1)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,6,1)=+rrr(4)+rxyz(19)*qx
      eri(5,2,6,1)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,6,1)=+rrr(8)+rxyz(19)*qz
      eri(1,3,6,1)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,6,1)=+rrr(8)+rxyz(6)*qz
      eri(3,3,6,1)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,6,1)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,6,1)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,6,1)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      do i= 1,3
        do j= 1,6
...
!
      ...
      eri(1,1,2,2)=rrr(1)+(rxyz(1)*two+rxyz(2)) &
&                  *qx+(rxyz(3)+rxyz(4)*two)*xx &
&                  +rxyz(5)*xxx
      eri(2,1,2,2)=+rrr(4)+rxyz(6)*qx
      eri(3,1,2,2)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,2,2)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,2,2)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1) &
&                  *qz+rxyz(12)*xx+(rxyz(3)+rxyz(4)) &
&                  *xz+rxyz(5)*xxz
      eri(6,1,2,2)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,2,2)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,2,2)=+rrr(7)
      eri(3,2,2,2)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,2,2)=+rrr(4)+rxyz(19)*qx
      eri(5,2,2,2)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,2,2)=+rrr(8)+rxyz(19)*qz
      eri(1,3,2,2)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,2,2)=+rrr(8)+rxyz(6)*qz
      eri(3,3,2,2)=+rrr(10)+(rxyz(7)*two+rxyz(8)) &
&                  *qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,2,2)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,2,2)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10)) &
&                  *qz+(rxyz(11)+rxyz(12))*xz &
&                  +rxyz(4)*zz+rxyz(5)*xzz
      eri(6,3,2,2)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             -r2(6,7)*three-r2(6,13)*three
      ...
      rxyz( 6)=-r5(18,4)+r4(12,5)*two-r3(7,5)-r3(7,9)-r3(9,17)+r2(6,17)*two-r1(2,11)-r1(2,17)
      rxyz( 7)=-r5(20,3)+r4(14,4)*two-r3(9,4)-r3(9,8)-r3(9,16)+r2(6,16)*two-r1(2,10)-r1(2,16)
      rxyz( 8)=-r5(20,4)+r4(14,5)*two-r3(9,5)-r3(9,9)-r3(9,17)+r2(6,17)*two-r1(2,11)-r1(2,17)
      ...
      rxyz(19)=-r5(18,3)+r4(12,4)*two-r3(7,4)-r3(7,8)-r3(9,16)+r2(6,16)*two-r1(2,10)-r1(2,16)
      eri(1,1,3,2)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,3,2)=+rrr(4)+rxyz(6)*qx
      eri(3,1,3,2)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,3,2)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,3,2)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,3,2)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,3,2)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,3,2)=+rrr(7)
      eri(3,2,3,2)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,3,2)=+rrr(4)+rxyz(19)*qx
      eri(5,2,3,2)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,3,2)=+rrr(8)+rxyz(19)*qz
      eri(1,3,3,2)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,3,2)=+rrr(8)+rxyz(6)*qz
      eri(3,3,3,2)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,3,2)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,3,2)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,3,2)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      do i= 1,3
        do j= 1,6
...
&             -r2(3,13)*three+r1(3,4)*three
      ...
      eri(1,1,6,2)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,6,2)=+rrr(4)+rxyz(6)*qx
      eri(3,1,6,2)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,6,2)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,6,2)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,6,2)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,6,2)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,6,2)=+rrr(7)
      eri(3,2,6,2)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,6,2)=+rrr(4)+rxyz(19)*qx
      eri(5,2,6,2)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,6,2)=+rrr(8)+rxyz(19)*qz
      eri(1,3,6,2)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,6,2)=+rrr(8)+rxyz(6)*qz
      eri(3,3,6,2)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,6,2)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,6,2)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,6,2)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             -r2(3,13)*three+r1(3,7)*three
      ...
      eri(1,1,1,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,1,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,1,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,1,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,1,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,1,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,1,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,1,3)=+rrr(7)
      eri(3,2,1,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,1,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,1,3)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,1,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,1,3)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,1,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,1,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,1,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,1,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,1,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             -r2(3,13)*three+r1(3,7)*three
      ...
      eri(1,1,2,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,2,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,2,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,2,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,2,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,2,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,2,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,2,3)=+rrr(7)
      eri(3,2,2,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,2,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,2,3)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,2,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,2,3)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,2,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,2,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,2,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,2,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,2,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&              -r1(3,17)*three+r0(2)+r0(5)*two+r0(8)
      rxyz( 3)=-r4(10,9)+r3(6,11)*two+r3(6,14)-r2(5,8)-r2(5,11)*two-r2(5,14)*three+r1(1,2) &
&              +r1(1,5)*two+r1(1,8)
      rxyz( 4)=-r4(10,10)+r3(6,12)*two+r3(6,15)-r2(5,9)-r2(5,12)*two-r2(5,15)*three+r1(1,3) &
&              +r1(1,6)*two+r1(1,9)
      rxyz( 5)=-r3(10,18)+r2(3,18)*two+r2(3,21)-r1(3,12)-r1(3,15)*two-r1(3,18)*three+r0(3) &
&              +r0(6)*two+r0(9)
      rxyz( 6)=-r5(19,4)+r4(13,5)*two+r4(13,7)-r3(8,5)-r3(8,7)*two-r3(8,9)*three-r3(10,17) &
&              +r2(2,2)+r2(2,4)*two+r2(2,6)+r2(3,17)*two+r2(3,20)-r1(3,11)-r1(3,14)*two &
&              -r1(3,17)*three+r0(2)+r0(5)*two+r0(8)
      rxyz( 7)=-r5(21,3)+r4(15,4)*two+r4(15,6)-r3(10,4)-r3(10,6)*two-r3(10,8)*three-r3(10,16) &
&              +r2(3,1)+r2(3,3)*two+r2(3,5)+r2(3,16)*two+r2(3,19)-r1(3,10)-r1(3,13)*two &
&              -r1(3,16)*three+r0(1)+r0(4)*two+r0(7)
      rxyz( 8)=-r5(21,4)+r4(15,5)*two+r4(15,7)-r3(10,5)-r3(10,7)*two-r3(10,9)*three-r3(10,17) &
...
&              +r2(5,4)*two+r2(5,6)
      rxyz(11)=-r4(15,9)+r3(10,11)*two+r3(10,14)-r2(3,8)-r2(3,11)*two-r2(3,14)*three+r1(3,2) &
&              +r1(3,5)*two+r1(3,8)
      rxyz(12)=-r4(15,10)+r3(10,12)*two+r3(10,15)-r2(3,9)-r2(3,12)*two-r2(3,15)*three+r1(3,3) &
&              +r1(3,6)*two+r1(3,9)
...
&              +r2(6,4)*two+r2(6,6)
      rxyz(17)=-r4(14,9)+r3(9,11)*two+r3(9,14)-r2(6,8)-r2(6,11)*two-r2(6,14)*three+r1(2,2) &
&              +r1(2,5)*two+r1(2,8)
      rxyz(18)=-r4(14,10)+r3(9,12)*two+r3(9,15)-r2(6,9)-r2(6,12)*two-r2(6,15)*three+r1(2,3) &
&              +r1(2,6)*two+r1(2,9)
      rxyz(19)=-r5(19,3)+r4(13,4)*two+r4(13,6)-r3(8,4)-r3(8,6)*two-r3(8,8)*three-r3(10,16) &
&              +r2(2,1)+r2(2,3)*two+r2(2,5)+r2(3,16)*two+r2(3,19)-r1(3,10)-r1(3,13)*two &
&              -r1(3,16)*three+r0(1)+r0(4)*two+r0(7)
      eri(1,1,3,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,3,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,3,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,3,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,3,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,3,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,3,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,3,3)=+rrr(7)
      eri(3,2,3,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,3,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,3,3)=rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,3,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,3,3)=rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,3,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,3,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,3,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,3,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,3,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      ...
      eri(1,1,4,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,4,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,4,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,4,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,4,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,4,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,4,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,4,3)=+rrr(7)
      eri(3,2,4,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,4,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,4,3)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,4,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,4,3)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,4,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,4,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,4,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,4,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,4,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             +r3(6,10)*three+r3(6,13)*three-r2(5,10)*three-r2(5,13)*three
      rxyz( 1)=-r5(6,3)+r4(3,4)+r4(3,6)-r3(1,6)-r3(1,8)-r3(6,16)+r2(5,16)+r2(5,19)-r1(1,13) &
&              -r1(1,16)
      rxyz( 2)=-r5(6,4)+r4(3,5)+r4(3,7)-r3(1,7)-r3(1,9)-r3(6,17)+r2(5,17)+r2(5,20)-r1(1,14) &
&              -r1(1,17)
      ...
      rxyz( 6)=-r5(13,4)+r4(8,5)+r4(8,7)-r3(4,7)-r3(4,9)-r3(6,17)+r2(5,17)+r2(5,20)-r1(1,14) &
&              -r1(1,17)
      rxyz( 7)=-r5(15,3)+r4(10,4)+r4(10,6)-r3(6,6)-r3(6,8)-r3(6,16)+r2(5,16)+r2(5,19)-r1(1,13) &
&              -r1(1,16)
      rxyz( 8)=-r5(15,4)+r4(10,5)+r4(10,7)-r3(6,7)-r3(6,9)-r3(6,17)+r2(5,17)+r2(5,20)-r1(1,14) &
&              -r1(1,17)
      ...
      rxyz(19)=-r5(13,3)+r4(8,4)+r4(8,6)-r3(4,6)-r3(4,8)-r3(6,16)+r2(5,16)+r2(5,19)-r1(1,13) &
&              -r1(1,16)
      eri(1,1,5,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,5,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,5,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,5,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,5,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,5,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,5,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,5,3)=+rrr(7)
      eri(3,2,5,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,5,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,5,3)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,5,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,5,3)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,5,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,5,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,5,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,5,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,5,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
...
&             +r3(9,10)*three+r3(9,13)*three-r2(6,10)*three-r2(6,13)*three
      rxyz( 1)=-r5(9,3)+r4(5,4)+r4(5,6)-r3(2,6)-r3(2,8)-r3(9,16)+r2(6,16)+r2(6,19)-r1(2,13) &
&              -r1(2,16)
      rxyz( 2)=-r5(9,4)+r4(5,5)+r4(5,7)-r3(2,7)-r3(2,9)-r3(9,17)+r2(6,17)+r2(6,20)-r1(2,14) &
&              -r1(2,17)
      ...
      rxyz( 6)=-r5(18,4)+r4(12,5)+r4(12,7)-r3(7,7)-r3(7,9)-r3(9,17)+r2(6,17)+r2(6,20)-r1(2,14) &
&              -r1(2,17)
      rxyz( 7)=-r5(20,3)+r4(14,4)+r4(14,6)-r3(9,6)-r3(9,8)-r3(9,16)+r2(6,16)+r2(6,19)-r1(2,13) &
&              -r1(2,16)
      rxyz( 8)=-r5(20,4)+r4(14,5)+r4(14,7)-r3(9,7)-r3(9,9)-r3(9,17)+r2(6,17)+r2(6,20)-r1(2,14) &
&              -r1(2,17)
      ...
      rxyz(19)=-r5(18,3)+r4(12,4)+r4(12,6)-r3(7,6)-r3(7,8)-r3(9,16)+r2(6,16)+r2(6,19)-r1(2,13) &
&              -r1(2,16)
      eri(1,1,6,3)=+rrr(1)+(rxyz(1)*two+rxyz(2))*qx+(rxyz(3)+rxyz(4)*two)*xx+rxyz(5)*xxx
      eri(2,1,6,3)=+rrr(4)+rxyz(6)*qx
      eri(3,1,6,3)=+rrr(6)+rxyz(8)*qx+rxyz(9)*two*qz+rxyz(12)*two*xz+rxyz(3)*zz+rxyz(5)*xzz
      eri(4,1,6,3)=+rrr(2)+(rxyz(13)+rxyz(14))*qx+rxyz(18)*xx
      eri(5,1,6,3)=+rrr(3)+(rxyz(9)+rxyz(10))*qx+rxyz(1)*qz+rxyz(12)*xx+(rxyz(3)+rxyz(4))*xz &
&                  +rxyz(5)*xxz
      eri(6,1,6,3)=+rrr(5)+rxyz(16)*qx+rxyz(13)*qz+rxyz(18)*xz
      eri(1,2,6,3)=+rrr(2)+rxyz(13)*two*qx+rxyz(17)*xx
      eri(2,2,6,3)=+rrr(7)
      eri(3,2,6,3)=+rrr(9)+rxyz(15)*two*qz+rxyz(17)*zz
      eri(4,2,6,3)=+rrr(4)+rxyz(19)*qx
      eri(5,2,6,3)=+rrr(5)+rxyz(15)*qx+rxyz(13)*qz+rxyz(17)*xz
      eri(6,2,6,3)=+rrr(8)+rxyz(19)*qz
      eri(1,3,6,3)=+rrr(3)+rxyz(9)*two*qx+rxyz(2)*qz+rxyz(11)*xx+rxyz(4)*two*xz+rxyz(5)*xxz
      eri(2,3,6,3)=+rrr(8)+rxyz(6)*qz
      eri(3,3,6,3)=+rrr(10)+(rxyz(7)*two+rxyz(8))*qz+(rxyz(11)+rxyz(12)*two)*zz+rxyz(5)*zzz
      eri(4,3,6,3)=+rrr(5)+rxyz(15)*qx+rxyz(14)*qz+rxyz(18)*xz
      eri(5,3,6,3)=+rrr(6)+rxyz(7)*qx+(rxyz(9)+rxyz(10))*qz+(rxyz(11)+rxyz(12))*xz+rxyz(4)*zz &
&                  +rxyz(5)*xzz
      eri(6,3,6,3)=+rrr(9)+(rxyz(15)+rxyz(16))*qz+rxyz(18)*zz
!
      return
end
